...
// missing target.
func projectObservations(requested []string, o simulatorapi.Observations) (Observations, error) {
	metadata := o.Metadata
	if err := validateMetadata(metadata); err != nil {
		return Observations{}, err
	}
	clock, err := validateTime(&upstreamTime{Now: &o.Time.Now, ElapsedMs: &o.Time.ElapsedMs, Speed: &o.Time.Speed, Paused: &o.Time.Paused}, metadata.StartedAt, metadata.Settings.Speed)
	if err != nil {
		return Observations{}, err
	}
...
func projectReceptionPage(stationID string, req simulatorapi.HistoryRequest, page simulatorapi.ReceptionPage) (ReceptionPage, error) {
