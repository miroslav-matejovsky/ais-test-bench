...
//
// EncodePosition validates navigation inputs and the radio channel (A or B),
// converts decimal degrees and knots to AIS units and signed bit fields, and
// returns the checksummed sentence with CRLF. Reports use underway status, unavailable rate of turn, default
// accuracy/RAIM/radio state, and the supplied UTC second. Every generated
// sentence is parsed by go-nmea before it is returned.
//
// DecodePosition reads the radio channel and type 1 fields back into a Report. It supports only
