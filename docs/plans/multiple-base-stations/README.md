...
(reception and coverage model), 03 (engine observations), 04 (simulator API
and manager controls), 05 (display backend), and 06 (display interface) are
implemented; step 07 is future work.
